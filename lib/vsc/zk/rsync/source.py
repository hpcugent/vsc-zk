...
class RsyncSource(RsyncController):
    ...
    def __init__(self, hosts, session=None, name=None, default_acl=None,
                 ...
                 netcat=False, dryrun=False, delete=False, excluderdir=None):
    ...
    def build_pathqueue(self):
        ...
        if self.netcat:
            ...
            tuplpaths = get_pathlist(self.rsyncpath, self.rsyncdepth, exclude_rootdir=self.excluderdir)
